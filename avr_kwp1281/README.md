...
After I reverse engineered the firmware for the Premium 4 radio, I found that it responds to several hidden KWP1281 commands.  I wanted to send the commands but I had no way to do so.  The scan tool I normally use, [Ross-Tech VCDS](http://www.ross-tech.com/vag-com/), does not provide any access to the
